...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  PredictResult predict(PredictRequest request)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := prediction.NewPredictorClientFactory(trans, protocolFactory)
	...
	case "predict":
		...
		argvalue0 := prediction.NewPredictRequest()
